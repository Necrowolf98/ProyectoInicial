<template>
  <v-app style="background-color: #f5f5f5">
    <v-navigation-drawer :mini-variant.sync="miniVariant" clipped v-model="drawer" fixed app>
      <v-list nav>
  ...
  data() {
    return {
      ...
      items: [
        ...
        { icon: "mdi-account", title: "User", to: "user.index" },
        { icon: "mdi-account", title: "Profile", to: "profile.index" }
      ],
      miniVariant: false,
    };
  },
